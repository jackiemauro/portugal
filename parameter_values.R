...
lgiv_params = list(mux1 = c(1.3), sigx1 = c(sqrt(.2)),
              muz = 1.5,sigz = 1.5,
              beta1 = c(-.15), gamma1 = c(-.2), pi1 = list(c(.2)),
              beta2 = -.5, gamma2 = -.05, pi2 = list(c(.7)),
              sig_v = 2, sig_u=1, tau0=.04, tau1 = .02)

cr_params = list(mux1 = c(.2), sigx1 = c(sqrt(.2)),
                 muz = 1.5,sigz = sqrt(.5),
                 beta1 = c(-.5), gamma1 = c(-.2), pi1 = list(c(2)),
                 beta2 = -.8, gamma2 = -.5, pi2 = list(c(.7)),
...
lgiv_params_mult = list(mux1 = c(2,.3), sigx1 = c(sqrt(.2),sqrt(.02)),
                      muz = c(.5,1.5,-.01),sigz = c(1.5,1,2),
                      beta1 = c(.5,-.02), gamma1 = c(-.2,-.01),
                      pi1 = list(c(2,1),c(.2),c(.8)),
                      beta2 = c(-.8, -1.2,.03), gamma2 = c(-.05,-.04,.05), 
                      pi2 = list(c(.7,.03,-.02),c(-.2,.09,-.09),c(1,-.02,.03)),
                      sig_v = c(2,2,3), sig_u=1, 
